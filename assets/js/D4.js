...
/* ESERCIZIO 5
  ...
  */
  ...
  starWarsCharacters.forEach( function(val){
    switch (val.eye_color){
      case 'blue':
      eyeColor.blue.push(val);
      break;
      case 'yellow':
      eyeColor.yellow.push(val);
      break;
      case 'brown':
      eyeColor.brown.push(val);
      break;
      case 'red':
      eyeColor.red.push(val);
      break;
      case 'blue-gray':
      eyeColor.blue_gray.push(val);
      break;
    }
  });
...
/* ESERCIZIO 6
  ...
  */
  ...
  while(indice < starWarsCharacters.length){
    totale += starWarsCharacters[indice].mass;
    indice++;
  }

  console.log("massa equipaggio: " + totale);
/* ESERCIZIO 7
...
starWarsCharacters.filter(function(val){
    return val.gender == 'n/a';
...
var casual = starWarsCharacters.map(function(val){
